...
json_file_name = r'new_data_logs\lpips\different_rho/lpips_test_on_band_lim_noise_different_rho_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\lpips\different_rho/lpips_test_on_band_lim_noise_different_rho_contour_plot_ppd_60_final_aim.json'

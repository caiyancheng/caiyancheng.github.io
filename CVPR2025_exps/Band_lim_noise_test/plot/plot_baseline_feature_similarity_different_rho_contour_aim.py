...
save_root_path = 'new_contour_plots/baseline/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/baseline/different_rho/baseline_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final_aim.json'
with open(json_data_path, 'r') as fp:
    plot_json_data = json.load(fp)
aim_cos_similarity_nf = plot_json_data['aim_cos_similarity']
aim_cos_similarity_f = plot_json_data['aim_cos_similarity_f']
rho_list = plot_json_data['rho_list']
multiplier_list = plot_json_data['multiplier_list']
Spearman_matrix_cos_nf = plot_json_data['Spearman_matrix_cos']
Spearman_matrix_cos_f = plot_json_data['Spearman_matrix_cos_f']
...
plot_cos_similarity_matrix_f_list = plot_json_data['cos_similarity_matrix_fix_random_seed']
...
plot_cos_similarity_matrix_nf = np.array(plot_cos_similarity_matrix_list[0])
plot_cos_similarity_matrix_f = np.array(
    plot_cos_similarity_matrix_f_list[0])
...
plot_cos_similarity_matrix_list = [plot_cos_similarity_matrix_nf, plot_cos_similarity_matrix_f]
plot_figure_name_list = ['cos similarity - baseline', 'cos similarity - baseline - fix_random_seed']

for figure_index in range(len(aim_cos_similarity_list)):

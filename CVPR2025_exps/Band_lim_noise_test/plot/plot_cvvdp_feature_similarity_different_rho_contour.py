...
save_root_path = 'contour_plots/cvvdp/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/cvvdp/different_rho/cvvdp_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final.json'

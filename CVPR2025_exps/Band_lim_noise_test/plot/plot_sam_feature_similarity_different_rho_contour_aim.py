...
json_data_path = rf'../test/new_data_logs/sam/different_rho/sam_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final_aim.json'
...
for backbone_index in tqdm(range(len(backbone_name_list))):
    ...
    plot_figure_name_list = ['cos similarity - sam', 'cos similarity - sam fix_random_seed']

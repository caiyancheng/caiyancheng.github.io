...
save_root_path = 'new_contour_plots/stlpips/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/stlpips/different_rho/stlpips_test_on_band_lim_noise_different_rho_contour_plot_ppd_{ppd}_final_aim.json'
...
Spearman_matrix_stlpips_alex = plot_json_data['Spearman_matrix_alex']
Spearman_matrix_stlpips_vgg = plot_json_data['Spearman_matrix_vgg']
Spearman_matrix_stlpips_alex_f = plot_json_data['Spearman_matrix_alex_f']
Spearman_matrix_stlpips_vgg_f = plot_json_data['Spearman_matrix_vgg_f']
...
Spearman_matrix_list = [Spearman_matrix_stlpips_alex, Spearman_matrix_stlpips_vgg, Spearman_matrix_stlpips_alex_f, Spearman_matrix_stlpips_vgg_f]

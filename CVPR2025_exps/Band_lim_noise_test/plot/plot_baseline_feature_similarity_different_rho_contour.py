...
save_root_path = 'contour_plots/baseline/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/baseline/different_rho/baseline_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final.json'
...
plot_L1_similarity_matrix_f_list = plot_json_data['L1_similarity_matrix_fix_random_seed']
plot_L2_similarity_matrix_f_list = plot_json_data['L2_similarity_matrix_fix_random_seed']
...
plot_L1_similarity_matrix_f = np.array(plot_L1_similarity_matrix_f_list[0])
plot_L2_similarity_matrix_f = np.array(plot_L2_similarity_matrix_f_list[0])
...
plot_figure_data_matrix_list = [plot_L1_similarity_matrix,
                                ...
                                plot_L1_similarity_matrix_f,
                                plot_L2_similarity_matrix_f,
                                plot_cos_similarity_matrix_f]
plot_figure_name_list = [f'L1 similarity - baseline',
                         f'L2 similarity - baseline',
                         f'cos similarity - baseline',
                         f'L1 similarity - baseline - fix_random_seed',
                         f'L2 similarity - baseline - fix_random_seed',
                         f'cos similarity - baseline - fix_random_seed']

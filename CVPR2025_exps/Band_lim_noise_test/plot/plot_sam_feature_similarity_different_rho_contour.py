...
save_root_path = 'contour_plots/sam/different_rho'
os.makedirs(save_root_path, exist_ok=True)

for ppd_index in range(len(ppd_list)):
    ppd_number = ppd_list[ppd_index]
    json_data_path = rf'../test/new_data_logs/sam/different_rho/sam_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd_number}_final.json'

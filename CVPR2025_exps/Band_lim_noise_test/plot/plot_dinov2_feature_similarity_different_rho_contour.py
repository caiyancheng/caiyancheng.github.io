...
save_root_path = 'contour_plots/dinov2/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/dinov2/different_rho/dinov2_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final.json'
...
plot_intermediate_feature_L1_similarity_matrix_f_list = plot_json_data[
    'intermediate_feature_L1_similarity_matrix_fix_random_seed']
plot_intermediate_feature_L2_similarity_matrix_f_list = plot_json_data[
    'intermediate_feature_L2_similarity_matrix_fix_random_seed']
plot_intermediate_feature_cos_similarity_matrix_f_list = plot_json_data[
    'intermediate_feature_cos_similarity_matrix_fix_random_seed']
...
for backbone_index in tqdm(range(len(backbone_name_list))):
    ...
    plot_final_feature_L1_similarity_matrix_f = np.array(plot_final_feature_L1_similarity_matrix_f_list[backbone_index])
    plot_final_feature_L2_similarity_matrix_f = np.array(plot_final_feature_L2_similarity_matrix_f_list[backbone_index])
    ...
    plot_intermediate_feature_L1_similarity_matrix_f = np.array(
        plot_intermediate_feature_L1_similarity_matrix_f_list[backbone_index])
    plot_intermediate_feature_L2_similarity_matrix_f = np.array(
        plot_intermediate_feature_L2_similarity_matrix_f_list[backbone_index])
    plot_intermediate_feature_cos_similarity_matrix_f = np.array(
        plot_intermediate_feature_cos_similarity_matrix_f_list[backbone_index])
    plot_figure_data_matrix_list = [plot_final_feature_L1_similarity_matrix,
                                    ...
                                    plot_intermediate_feature_L1_similarity_matrix_f,
                                    plot_intermediate_feature_L2_similarity_matrix_f,
                                    plot_intermediate_feature_cos_similarity_matrix_f]
    plot_figure_name_list = [f'{backbone_name} - L1 similarity - final feature',
                             ...
                             f'{backbone_name} - L1 similarity - final feature - fix_random_seed',
                             f'{backbone_name} - L2 similarity - final feature - fix_random_seed',
                             f'{backbone_name} - cos similarity - final feature - fix_random_seed',
                             f'{backbone_name} - L1 similarity - intermediate feature - fix_random_seed',
                             f'{backbone_name} - L2 similarity - intermediate feature - fix_random_seed',
                             f'{backbone_name} - cos similarity - intermediate feature - fix_random_seed']

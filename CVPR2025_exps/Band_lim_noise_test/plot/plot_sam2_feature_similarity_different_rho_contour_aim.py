...
json_data_path = rf'../test/new_data_logs/sam2/different_rho/sam2_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final_aim.json'
...
backbone_name_list = plot_json_data['sam_model_name']
...
for backbone_index in tqdm(range(len(backbone_name_list))):
    ...
    plot_figure_name_list = ['cos similarity - sam2', 'cos similarity - sam2 fix_random_seed']

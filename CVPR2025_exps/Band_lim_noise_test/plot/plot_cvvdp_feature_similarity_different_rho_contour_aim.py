...
save_root_path = 'new_contour_plots/cvvdp/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/cvvdp/different_rho/cvvdp_test_on_band_lim_noise_different_rho_band_contour_plot_ppd_{ppd}_final_aim.json'
with open(json_data_path, 'r') as fp:
    plot_json_data = json.load(fp)
aim_JOD_nf = plot_json_data['aim_JOD']
aim_JOD_f = plot_json_data['aim_JOD_f']
rho_list = plot_json_data['rho_list']
multiplier_list = plot_json_data['multiplier_list']
Spearman_matrix_JOD_nf = plot_json_data['Spearman_matrix_JOD']
Spearman_matrix_JOD_f = plot_json_data['Spearman_matrix_JOD_f']
...
plot_JOD_score_matrix_f_list = plot_json_data['JOD_score_matrix_fix_random_seed']
...
plot_JOD_score_matrix_f = np.array(plot_JOD_score_matrix_f_list[0])

plot_figure_data_matrix_list = [plot_JOD_score_matrix,
                                plot_JOD_score_matrix_f]
plot_figure_name_list = [f'JOD Score - cvvdp',
                         f'JOD Score - cvvdp - fix_random_seed']
aim_JOD_list = [aim_JOD_nf, aim_JOD_f]
Spearman_matrix_list = [Spearman_matrix_JOD_nf, Spearman_matrix_JOD_f]

for figure_index in range(len(plot_figure_name_list)):
    figure_name = plot_figure_name_list[figure_index]
    Spearman_matrix_JOD = Spearman_matrix_list[figure_index]
    ...
    diff_list = list(abs(contours.levels - aim_JOD_list[figure_index]))

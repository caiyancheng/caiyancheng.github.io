...
json_data_path = rf'../test/new_data_logs/baseline/different_c/baseline_test_on_contrast_masking_different_c_contour_plot_ppd_{ppd}_final_aim.json'
...
# plt.show()
plt.savefig(os.path.join(save_root_path, 'cos similarity - baseline'), dpi=300, bbox_inches='tight', pad_inches=0.02)
plt.close()

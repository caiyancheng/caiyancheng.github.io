...
save_root_path = 'new_contour_plots/vae/different_c'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'new_data_logs/vae/different_c/vae_test_on_contrast_masking_different_c_contour_plot_ppd_{ppd}_final.json'

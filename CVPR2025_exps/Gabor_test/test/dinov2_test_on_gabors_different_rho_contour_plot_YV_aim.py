...
json_file_name = r'new_data_logs\dinov2\different_rho_YV/dinov2_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final.json'
save_json_file_name = r'new_data_logs\dinov2\different_rho_YV/dinov2_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final_aim.json'

...
save_root_path = 'new_data_logs/stlpips/different_rho_RG'
...
Spearman_matrix_lpips_alex = np.zeros([len(rho_list), len(multiplier_list)])
Spearman_matrix_lpips_vgg = np.zeros([len(rho_list), len(multiplier_list)])
...
json_file_name = r'new_data_logs\stlpips\different_rho_RG/stlpips_test_on_gabors_different_rho_contour_plot_ppd_60_RG_final.json'
save_json_file_name = r'new_data_logs\stlpips\different_rho_RG/stlpips_test_on_gabors_different_rho_contour_plot_ppd_60_RG_final_aim.json'

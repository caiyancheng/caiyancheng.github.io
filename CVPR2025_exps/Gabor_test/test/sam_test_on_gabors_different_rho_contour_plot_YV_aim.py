...
for ppd_index in tqdm(range(len(ppd_list))):
    ...
    json_file_name = rf'new_data_logs\sam\different_rho_YV/sam_test_on_gabors_different_rho_contour_plot_ppd_{ppd_number}_YV_final.json'
    save_json_file_name = rf'new_data_logs\sam\different_rho_YV/sam_test_on_gabors_different_rho_contour_plot_ppd_{ppd_number}_YV_final_aim.json'

...
json_file_name = r'new_data_logs\stlpips\different_rho/stlpips_test_on_gabors_different_rho_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\stlpips\different_rho/stlpips_test_on_gabors_different_rho_contour_plot_ppd_60_final_aim.json'

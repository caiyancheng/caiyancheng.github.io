...
save_root_path = 'new_data_logs/baseline/different_rho_YV'
...
json_file_name = r'new_data_logs\baseline\different_rho_YV/baseline_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final.json'
save_json_file_name = r'new_data_logs\baseline\different_rho_YV/baseline_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final_aim.json'

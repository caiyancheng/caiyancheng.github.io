...
save_root_path = 'new_data_logs/sam/different_rho_RG'
...
for ppd_index in tqdm(range(len(ppd_list))):
    ...
    T_vid_aim, R_vid_aim = generate_gabor_patch(W=default_W, H=default_H, R=default_R, rho=middle_rho,
                                        ...
                                        ppd=ppd_number, color_direction='rg')
    ...
    json_file_name = rf'new_data_logs\sam\different_rho_RG/sam_test_on_gabors_different_rho_contour_plot_ppd_{ppd_number}_RG_final.json'
    save_json_file_name = rf'new_data_logs\sam\different_rho_RG/sam_test_on_gabors_different_rho_contour_plot_ppd_{ppd_number}_RG_final_aim.json'

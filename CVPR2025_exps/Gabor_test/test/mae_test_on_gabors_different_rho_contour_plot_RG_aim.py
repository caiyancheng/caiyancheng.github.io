...
json_file_name = r'new_data_logs\mae\different_rho_RG/mae_test_on_gabors_different_rho_contour_plot_ppd_60_RG_final.json'
save_json_file_name = r'new_data_logs\mae\different_rho_RG/mae_test_on_gabors_different_rho_contour_plot_ppd_60_RG_final_aim.json'

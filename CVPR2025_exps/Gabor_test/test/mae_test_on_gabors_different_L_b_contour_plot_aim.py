...
json_file_name = r'new_data_logs\mae\different_luminance/mae_test_on_gabors_different_luminance_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\mae\different_luminance/mae_test_on_gabors_different_luminance_contour_plot_ppd_60_final_aim.json'

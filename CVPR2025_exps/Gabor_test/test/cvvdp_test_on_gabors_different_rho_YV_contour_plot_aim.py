...
save_root_path = 'new_data_logs/cvvdp/different_rho_YV'
...
Spearman_matrix_JOD = np.zeros([len(rho_change_list), len(multiplier_list)])
...
json_file_name = r'new_data_logs\cvvdp\different_rho_YV/cvvdp_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final.json'
save_json_file_name = r'new_data_logs\cvvdp\different_rho_YV/cvvdp_test_on_gabors_different_rho_contour_plot_ppd_60_YV_final_aim.json'

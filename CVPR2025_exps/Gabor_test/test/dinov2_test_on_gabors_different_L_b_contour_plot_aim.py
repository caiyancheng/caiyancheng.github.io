...
json_file_name = r'new_data_logs\dinov2\different_luminance/dinov2_test_on_gabors_different_L_b_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\dinov2\different_luminance/dinov2_test_on_gabors_different_L_b_contour_plot_ppd_60_final_aim.json'

...
json_file_name = r'new_data_logs\openclip\different_rho/openclip_test_on_gabors_different_rho_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\openclip\different_rho/openclip_test_on_gabors_different_rho_contour_plot_ppd_60_final_aim.json'

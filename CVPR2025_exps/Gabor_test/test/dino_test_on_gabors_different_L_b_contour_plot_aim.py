...
json_file_name = r'new_data_logs\dino\different_luminance/dino_test_on_gabors_different_L_b_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\dino\different_luminance/dino_test_on_gabors_different_L_b_contour_plot_ppd_60_final_aim.json'

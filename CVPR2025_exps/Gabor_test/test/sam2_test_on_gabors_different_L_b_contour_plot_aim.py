...
for ppd_index in tqdm(range(len(ppd_list))):
    ...
    json_file_name = rf'new_data_logs\sam2\different_luminance/sam2_test_on_gabors_different_luminance_contour_plot_ppd_{ppd_number}_final.json'
    save_json_file_name = rf'new_data_logs\sam2\different_luminance/sam2_test_on_gabors_different_luminance_contour_plot_ppd_{ppd_number}_final_aim.json'

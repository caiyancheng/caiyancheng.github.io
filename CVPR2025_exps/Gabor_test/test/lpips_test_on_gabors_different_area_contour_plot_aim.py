...
json_file_name = r'new_data_logs\lpips\different_area/lpips_test_on_gabors_different_area_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\lpips\different_area/lpips_test_on_gabors_different_area_contour_plot_ppd_60_final_aim.json'

...
json_data_path = rf'../test/new_data_logs/baseline/different_luminance/baseline_test_on_gabors_different_L_b_contour_plot_ppd_{ppd}_final_aim.json'
...
contours = plt.contour(plot_L_b_matrix, 1 / plot_contrast_matrix, plot_cos_similarity_matrix,
...
gt_f_interp = interp1d(castleCSF_result_luminance_list, castleCSF_result_sensitivity_list, kind='linear', fill_value="extrapolate")

...
save_root_path = 'contour_plots_arc_scale/sam/different_rho_YV'
os.makedirs(save_root_path, exist_ok=True)

for ppd_index in range(len(ppd_list)):
    ppd_number = ppd_list[ppd_index]
    json_data_path = rf'../test/new_data_logs/sam/different_rho_YV/sam_test_on_gabors_different_rho_contour_plot_ppd_{ppd_number}_YV_final.json'

...
save_root_path = 'new_contour_plots/openclip/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/openclip/different_luminance/openclip_test_on_gabors_different_luminance_contour_plot_ppd_{ppd}_final_aim.json'

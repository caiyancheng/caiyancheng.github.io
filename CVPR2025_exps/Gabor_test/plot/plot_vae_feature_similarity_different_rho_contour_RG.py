...
save_root_path = 'new_contour_plots/vae/different_rho_RG'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'new_data_logs/vae/different_rho_RG/vae_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_RG_final.json'

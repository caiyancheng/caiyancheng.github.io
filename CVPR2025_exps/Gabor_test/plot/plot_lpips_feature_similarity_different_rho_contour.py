...
save_root_path = 'contour_plots_arc_scale/lpips/different_rho'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/lpips/different_rho/lpips_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_final.json'

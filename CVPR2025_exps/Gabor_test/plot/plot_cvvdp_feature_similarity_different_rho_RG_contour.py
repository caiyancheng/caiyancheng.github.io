...
save_root_path = 'contour_plots_arc_scale/cvvdp/different_rho_RG'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/cvvdp/different_rho_RG/cvvdp_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_RG_final.json'

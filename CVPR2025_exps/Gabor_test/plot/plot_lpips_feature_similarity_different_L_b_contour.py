...
save_root_path = 'contour_plots_arc_scale/lpips/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/lpips/different_luminance/lpips_test_on_gabors_different_L_b_contour_plot_ppd_{ppd}_final.json'
...
max_loss_json_path = r'E:\Py_codes\LVM_Comparision\Feature_Similarity_paper_report\Compute_Max_Loss_all_models/max_loss_lpips.json'

...
save_root_path = 'new_contour_plots/dinov2/different_rho_RG'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/dinov2/different_rho_RG/dinov2_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_RG_final_aim.json'

...
save_root_path = 'contour_plots_arc_scale/dino/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/dino/different_luminance/dino_test_on_gabors_different_L_b_contour_plot_ppd_{ppd}_final.json'

...
json_data_path = rf'../test/new_data_logs/baseline/different_rho/baseline_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_final_aim.json'
...
gt_f_interp = interp1d(castleCSF_result_rho_list, castleCSF_result_sensitivity_list, kind='linear', fill_value="extrapolate")

...
save_root_path = 'contour_plots_arc_scale/dinov2/different_rho_YV'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/dinov2/different_rho_YV/dinov2_test_on_gabors_different_rho_contour_plot_ppd_{ppd}_YV_final.json'

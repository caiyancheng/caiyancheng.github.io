...
save_root_path = 'new_contour_plots/vae/different_area'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/vae/different_area/vae_test_on_gabors_different_area_contour_plot_ppd_{ppd}_final_aim.json'
...
for vae_model_index in tqdm(range(len(vae_model_name_list))):
    ...
    plot_area_matrix = np.array(plot_area_matrix_list[vae_model_index])
    ...
    # plt.tight_layout()
    plt.legend()
    plt.savefig(os.path.join(real_save_path, 'cos similarity - vae'),

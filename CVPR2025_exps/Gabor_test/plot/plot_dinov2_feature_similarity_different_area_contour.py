...
save_root_path = 'contour_plots_arc_scale/dinov2/different_area'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/dinov2/different_area/dinov2_test_on_gabors_different_area_contour_plot_ppd_{ppd}_final.json'

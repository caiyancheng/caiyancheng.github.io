...
save_root_path = 'new_contour_plots/sam/different_area'
os.makedirs(save_root_path, exist_ok=True)

for ppd_index in range(len(ppd_list)):
    ppd_number = ppd_list[ppd_index]
    json_data_path = rf'../test/new_data_logs/sam/different_area/sam_test_on_gabors_different_area_contour_plot_ppd_{ppd_number}_final_aim.json'

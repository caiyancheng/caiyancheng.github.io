...
save_root_path = 'contour_plots/vae/different_area'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/vae/different_area/vae_test_on_gabors_different_area_contour_plot_ppd_{ppd}_final.json'

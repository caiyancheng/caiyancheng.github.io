...
save_root_path = 'new_contour_plots/mae/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/mae/different_luminance/mae_test_on_gabors_different_luminance_contour_plot_ppd_{ppd}_final_aim.json'

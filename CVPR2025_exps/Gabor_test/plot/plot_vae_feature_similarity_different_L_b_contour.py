...
save_root_path = 'contour_plots/vae/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/vae/different_luminance/vae_test_on_gabors_different_luminance_contour_plot_ppd_{ppd}_final.json'

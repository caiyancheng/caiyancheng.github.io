...
save_root_path = 'contour_plots_arc_scale/mae/different_luminance'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/mae/different_luminance/mae_test_on_gabors_different_luminance_contour_plot_ppd_{ppd}_final.json'
...
for mae_model_index in tqdm(range(len(mae_model_name_list))):
    ...
    plot_L_b_matrix = np.array(plot_L_b_matrix_list[mae_model_index])

...
for backbone_index in tqdm(range(len(backbone_name_list))):
    ...
    plt.gca().axis('off')
    # plt.show()
    plt.savefig(r'E:\All_Conference_Papers\CVPR25\Images/SCM.png', dpi=300, bbox_inches='tight',
                pad_inches=0.02)
    plt.close()

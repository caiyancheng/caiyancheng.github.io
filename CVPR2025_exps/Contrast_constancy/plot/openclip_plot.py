...
for backbone_index in tqdm(range(len(clip_model_name_list))):
    clip_model_name = clip_model_name_list[backbone_index]
    clip_model_trainset = clip_model_trainset_list[backbone_index]
    real_save_path = os.path.join(save_root_path, f'{clip_model_name} - {clip_model_trainset}')
    ...
    for reference_contrast_index in range(len(reference_contrast_list)):
        ...
        test_contrast_list = plot_json_data[f'{clip_model_name}-{clip_model_trainset}'][f'ref_contrast_{reference_contrast_value}_test_contrast_list']

...
json_file_name = r'new_data_logs\mae\different_c/mae_test_on_contrast_masking_different_c_contour_plot_ppd_60_final.json'
save_json_file_name = r'new_data_logs\mae\different_c/mae_test_on_contrast_masking_different_c_contour_plot_ppd_60_final_aim.json'

...
save_root_path = 'contour_plots/baseline/different_c'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/baseline/different_c/baseline_test_on_contrast_masking_different_c_contour_plot_ppd_{ppd}_final.json'
...
for figure_index in range(len(plot_figure_name_list)):
    ...
    contour = plt.contour(plot_contrast_mask_matrix, plot_contrast_test_matrix,
                plot_figure_data_matrix_list[figure_index],

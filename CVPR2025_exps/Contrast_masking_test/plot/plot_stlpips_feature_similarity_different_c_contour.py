...
save_root_path = 'contour_plots/stlpips/different_c'
os.makedirs(save_root_path, exist_ok=True)

json_data_path = rf'../test/new_data_logs/stlpips/different_c/stlpips_test_on_contrast_masking_different_c_contour_plot_ppd_{ppd}_final.json'
